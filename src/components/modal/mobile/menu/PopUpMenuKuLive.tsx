...
import { getVnLotto } from "@/apis/menu"; // Placeholder: This might need a different API call for Live KU
import Menu from "../../../menu-item/mobile/Menu";
import { useRouter } from "next/navigation";
import { useMenuStore } from "@/stores/useMenuStore";
// LiveKU 播放弹窗通过全局挂载（见 HomeMobile/Hot.tsx），这里不直接引入
...
function PopUpMenuKuLive() {
  ...
  const isOpen = useModalStore((state) =>
    state.isModalOpen(MODAL.MENU_KU_LIVE)
  );
...
export default PopUpMenuKuLive;
