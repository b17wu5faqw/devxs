...
const LiveVideo = ({ gType, winningCodes, gamePhase }: LiveVideoProps) => {
  ...
  useEffect(() => {
    (async () => {
      try {
        ...
        console.log("Received WS URL response:", res.data);
  ...
  const handleVolumeCtrl = () => {
    setShowVolumeCtrl(true);
  };
  ...
  return (
    <div className="relative h-[220px] overflow-hidden">
      ...
      {gamePhase === "waiting" && (
        <div className="absolute top-1 right-2 z-[200] flex gap-1">
      ...
      <div
        className="btn_volControl mute absolute w-[15%] h-10 top-0 left-0 cursor-pointer bg-no-repeat bg-center bg-[length:25px]"
        style={{
          backgroundImage:
            "url(https://cuvnfa.gs6168.com/images/graph/common/icon_volControl.svg)",
        }}
        onClick={handleVolumeCtrl}
      ></div>
